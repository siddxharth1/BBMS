	...
	<body>
		...
		<div class="contact-wrap">
			<div class="contact-in">
				<h1>Contact Info</h1>
				<h2><i class="fa fa-phone" aria-hidden="true"></i><a target="_blank" class="link" href="tel:011-43509999">011-43509999</a></h2>
				
				<h2><i class="fa fa-envelope" aria-hidden="true"></i><a target="_blank" class="link" href="mailto:gorakhnathbloodbank@gmail.com">gorakhnathbloodbank@gmail.com</a></h2>
				
				<h2><i class="fa fa-map-marker" aria-hidden="true"></i><a target="_blank" class="link" href="https://www.google.com/maps/search/blood+donation+center/">Locate camps</a></h2>
			...
			<div class="contact-in" style="padding: 0;">
